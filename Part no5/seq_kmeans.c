...
#pragma omp parallel shared(min_dist) num_threads(2)
{
  
#pragma omp single
    min_dist = euclid_dist_2(numCoords, object, clusters[0]);

#pragma omp for private(dist) schedule(dynamic, CHUNKSIZE)
...
#pragma omp for schedule(static)
    ...
    do {
      delta = 0.0;
#pragma omp parallel private(index, j) reduction(+:delta) num_threads(2)
{
